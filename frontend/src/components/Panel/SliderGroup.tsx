...
const LABEL_ICONS: Record<keyof Weights, LucideIcon> = {
  price: Wallet,
  access: Footprints,
  rating: Star,
  vibe: Sparkles,
  ...
  return (
    <div className="flex flex-col gap-6">
      {(Object.keys(WEIGHT_LABELS) as (keyof Weights)[]).map((key) => {
        ...
        return (
          <div key={key}>
            <label htmlFor={sliderId} className="mb-2 flex items-center justify-between text-sm font-black text-black">
